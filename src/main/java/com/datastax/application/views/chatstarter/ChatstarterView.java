package com.datastax.application.views.chatstarter;
...
@PageTitle("Chat starter")
@Route(value = "chat")
public class ChatstarterView extends HorizontalLayout {
    ...
    public ChatstarterView() {
        addClassNames("chatstarter-view", Width.FULL, Display.FLEX, Flex.AUTO);
        setSpacing(false);
